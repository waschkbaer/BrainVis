...
//#include "C:/Users/andre/Dropbox/MasterThesis/trinity_cleaning/ext/jpeglib/jpeglib.h"
#include <setjmp.h>
...
static void write_JPEG_fileDICOMTEST(char * filename, int quality, uint8_t* data, uint32_t width, uint32_t height)
{
   ...
   * more if you wish, though.
   */
  row_stride = image_width * 1.0f;	/* JSAMPLEs per row in image_buffer */
  int t = 0;
